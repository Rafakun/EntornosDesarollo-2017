Namespace NavajaSuiza.Application2
    Public Class App2Logica
        ...
        Public Shared Function ConvertirDinero(ByVal Dinero As Double, ByVal TipoConversion As Integer) As String
            '''Se establece el valor de conversión Euro-Peseta.
